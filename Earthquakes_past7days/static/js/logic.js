...
// Add GeoJSON data.
var torontoHoodData = "https://raw.githubusercontent.com/kkrizek06/Mapping_Earthquakes/main/torontoNeighborhoods.json";
...
d3.json(torontoHoodData).then(function(data) {
    console.log(data);
